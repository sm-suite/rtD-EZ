...
pullData = open("viz_range.txt", "r").read()
...
#viz_rng = np.arange(2, 13, 1) #total points range MLB
...
class MyWindow:
	def __init__(self, win):
		...
		if dType == 'fx':
			self.lblb=Label(win, text='Buy', bg='#FFFFFF', fg='black') #lbl1
			self.lbls=Label(win, text='Sell', bg='#FFFFFF', fg='#black') #lbl1
			self.lbl1=Label(win, text='Size', bg='#636363', fg='black') #lbl1
			self.lbl2=Label(win, text='Price', bg='#636363', fg='black')
			self.lbl3=Label(win, text='Strike', bg='#636363', fg='black')
			self.lbl4=Label(win, text='Size', bg='#636363', fg='black')
			self.lbl5=Label(win, text='Price', bg='#636363', fg='black')
			self.lbl6=Label(win, text='Strike', bg='#636363', fg='black')

		elif dType == 'tp':
			self.lblb=Label(win, text='Over', bg='#FFFFFF', fg='#000000') #lbl1
			self.lbls=Label(win, text='Under', bg='#FFFFFF', fg='#000000') #lbl1
			self.lbl1=Label(win, text='Risk', bg='#636363', fg='#FFFFFF') #lbl1
			self.lbl2=Label(win, text='Odds', bg='#636363', fg='#FFFFFF')
			self.lbl3=Label(win, text='Score', bg='#636363', fg='#FFFFFF')
			self.lbl4=Label(win, text='Risk', bg='#636363', fg='#FFFFFF')
			self.lbl5=Label(win, text='Odds', bg='#636363', fg='#FFFFFF')
			self.lbl6=Label(win, text='Score', bg='#636363', fg='#FFFFFF')
